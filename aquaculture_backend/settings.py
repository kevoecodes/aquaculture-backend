...
SECRET_KEY = 'django-insecure-k3=e29q8lc$tq-0ens5y%j@*%i4h#1da5j9nydx)c1(fc&!jcm'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', 'warehouse.hardtechinternational.com/']
...
WSGI_APPLICATION = 'aquaculture_backend.wsgi.application'
ASGI_APPLICATION = 'aquaculture_backend.routing.application'
